...
void MainAppUiBuilder::build_settings_menu(MainApp& app) {
    ...
    app.ukrainian_action = app.language_menu->addAction(QString());
    app.ukrainian_action->setCheckable(true);
    app.ukrainian_action->setData(static_cast<int>(Language::Ukrainian));
    app.language_group->addAction(app.ukrainian_action);
