...
## Covered commits
- `a5723e4` `2025-10-29` `chore(readme): update`
...
Before this commit, the repository reflected the state immediately preceding `a5723e4`. After this commit, the files listed above incorporated the exact delta shown in the excerpt and file list, which is why this entry is stored as its own chapter instead of being folded into a broader release note.
...
--- a/README.md
+++ b/README.md
@@ -41,11 +41,12 @@ AI File Sorter is a powerful, cross-platform desktop application that automates
 ### [1.0.0] - 2026-02-18
