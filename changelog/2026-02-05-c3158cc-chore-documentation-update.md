...
## Covered commits
- `c3158cc` `2026-02-05` `chore(documentation): update`
...
Before this commit, the repository reflected the state immediately preceding `c3158cc`. After this commit, the files listed above incorporated the exact delta shown in the excerpt and file list, which is why this entry is stored as its own chapter instead of being folded into a broader release note.
...
@@ -87,7 +87,7 @@ AI File Sorter runs entirely on your device, using local AI models such as LLaMa
