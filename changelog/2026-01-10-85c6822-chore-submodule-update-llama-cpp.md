# 2026-01-10: chore(submodule): update llama.cpp

## Covered commits
- `85c6822` `2026-01-10` `chore(submodule): update llama.cpp`
...
Before this commit, the repository reflected the state immediately preceding `85c6822`. After this commit, the files listed above incorporated the exact delta shown in the excerpt and file list, which is why this entry is stored as its own chapter instead of being folded into a broader release note.
...
@@ -1 +1 @@
-Subproject commit 53eb9435da3affa12a38a8b0fb29081698a8d1cc
