...
## Covered commits
- `448577a` `2026-01-11` `chore(screenshots): update`
...
- `M` `images/screenshots/sort-confirm-moved.png`

## What changed from what, why, and how
The commit updated screenshot assets in `images/screenshots/aifs-main-window-win.png`, `images/screenshots/aifs-progress-dialog-win.png`, `images/screenshots/sort-confirm-moved.png`. The repository moved from older UI imagery to newer captures that represented the current interface more accurately.

Before this commit, the repository reflected the state immediately preceding `448577a`. After this commit, the files listed above incorporated the exact delta shown in the excerpt and file list, which is why this entry is stored as its own chapter instead of being folded into a broader release note.
