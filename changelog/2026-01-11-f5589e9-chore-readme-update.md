...
## Covered commits
- `f5589e9` `2026-01-11` `chore(readme): update`
...
Before this commit, the repository reflected the state immediately preceding `f5589e9`. After this commit, the files listed above incorporated the exact delta shown in the excerpt and file list, which is why this entry is stored as its own chapter instead of being folded into a broader release note.
...
--- a/README.md
+++ b/README.md
@@ -46,6 +46,8 @@ Image content analysis for supported picture files is available; broader file-co
