# 2025-10-28: chore(gitignore): update

## Covered commits
- `341e9c9` `2025-10-28` `chore(gitignore): update`
...
Before this commit, the repository reflected the state immediately preceding `341e9c9`. After this commit, the files listed above incorporated the exact delta shown in the excerpt and file list, which is why this entry is stored as its own chapter instead of being folded into a broader release note.
...
--- a/.gitignore
+++ b/.gitignore
@@ -102,4 +102,8 @@ app/include/llama/*.h
 !app/scripts/
 /tools/
