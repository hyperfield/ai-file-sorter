# 2025-09-22: chore(readme): version update

## Covered commits
- `b85f8d0` `2025-09-22` `chore(readme): version update`
...
Before this commit, the repository reflected the state immediately preceding `b85f8d0`. After this commit, the files listed above incorporated the exact delta shown in the excerpt and file list, which is why this entry is stored as its own chapter instead of being folded into a broader release note.
