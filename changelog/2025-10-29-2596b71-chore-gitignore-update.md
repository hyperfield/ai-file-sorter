...
## Covered commits
- `2596b71` `2025-10-29` `chore(gitignore): update`
...
Before this commit, the repository reflected the state immediately preceding `2596b71`. After this commit, the files listed above incorporated the exact delta shown in the excerpt and file list, which is why this entry is stored as its own chapter instead of being folded into a broader release note.
...
--- a/.gitignore
+++ b/.gitignore
@@ -101,6 +101,7 @@ app/include/llama/*.h
 /scripts/
 !app/scripts/
 /tools/
+/reports/
