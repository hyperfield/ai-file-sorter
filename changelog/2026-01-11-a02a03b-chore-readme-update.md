...
## Covered commits
- `a02a03b` `2026-01-11` `chore(readme): update`
...
Before this commit, the repository reflected the state immediately preceding `a02a03b`. After this commit, the files listed above incorporated the exact delta shown in the excerpt and file list, which is why this entry is stored as its own chapter instead of being folded into a broader release note.
...
--- a/README.md
+++ b/README.md
@@ -185,7 +185,8 @@ File categorization with local LLMs is completely free of charge. If you prefer
